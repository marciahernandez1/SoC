...
void adc_check(XadcCore *adc_p, GpoCore *led_p) {
   ...
   for (i = 0; i < 5; i++) {
      ...
      //i just want channel 3, ergo:
      reading = adc_p->read_adc_in(3);
      uart.disp(reading, 3); //reading, up to 3 decimal places
      uart.disp("\n\r");
      /*for (n = 0; n < 4; n++) {
...
//check circuit
//connect input
//take picture for progress
//see if i can get reading, the rest will be tomorrows problem :)

//then, fic report 3

//then, read on beams and take another look at code!
